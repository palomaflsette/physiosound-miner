...
def segment_signal(signal: np.ndarray, fs: int, window_sec: float = 2.0, overlap: float = 0.5) -> List[np.ndarray]:
    """
    ...
    Parameters:
        ...
        window_sec (float): Duration of each window in seconds. Default is 2.0.
